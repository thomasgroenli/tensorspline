...
splines.so: splines.cc splines.h splinegrid_cpu.a splinegrid_gradient_cpu.a splinegrid_gpu.cu.a
	g++ -std=c++11 -shared splines.cc splinegrid_cpu.a splinegrid_gradient_cpu.a splinegrid_gpu.cu.a -o splines.so -fPIC $(TF_INC) $(TF_NSYNC) $(TF_LIB) -ltensorflow_framework $(FLAGS)
