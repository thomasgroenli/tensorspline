...
splinegrid_gpu.cu.a: splinegrid_gpu.cu.cc splines.h Makefile
...
splinegrid_gradient_gpu.cu.a: splinegrid_gradient_gpu.cu.cc splines.h Makefile
...
splinegrid_cpu.a: splinegrid_cpu.cc splines.h Makefile
	g++ -std=c++11 splinegrid_cpu.cc -c -o splinegrid_cpu.a -fPIC $(TF_INC) $(TF_NSYNC) $(TF_LIB) -ltensorflow_framework $(FLAGS)

splinegrid_gradient_cpu.a: splinegrid_gradient_cpu.cc splines.h Makefile
...
splines.so: splines.cc splines.h splinegrid_cpu.a splinegrid_gradient_cpu.a splinegrid_gpu.cu.a splinegrid_gradient_gpu.cu.a Makefile
